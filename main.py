...
for fashion_images in os.listdir('D:\CBVIR\e-commerce\images'):
    images_path = os.path.join('D:\CBVIR\e-commerce\images', fashion_images)
...
#     print(f'Default GPU :{tf.test.gpu_device_name()}')
# else:
#     print('plaese cheack the installation')
